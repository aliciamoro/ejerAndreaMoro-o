const http = require('http'); //Requiero el módulo http
const fs = require('fs'); //Requiero el modulo fs
...
http.createServer((req, res) => {
    ...
    switch (req.url) { 
        ...
        case '/': 
            ...
            titulos.sort(); /*ordena alfabericamente ojo las prioridades*/
            titulos.forEach(function(titulo){
                res.write(`** ${titulo}\n`)
            })
    
            res.write('\n')
            res.write("Recordá que podés visitar las secciones: ** En Cartelera  ** Más Votadas ** Sucursales ** Contacto ** Preguntas Frecuentes **")
        ...
        case '/mas-votadas':
            ...
            let votadas = movies.filter(function(movie) // filtra pelis con votos >7
            {
            ...
            /*toFixed para los digitos despues . */
        ...
        case '/contacto':
            ...
            res.write('Contenido: ¿Tenés algo para contarnos? Nos encanta escuchar a nuestros clientes. Si deseas contactarnos podés escribirnos al siguiente email: dhmovies@digitalhouse.com o en las redes sociales. Envianos tu consulta, sugerencia o reclamo y será respondido a la brevedad posible. Recordá que también podes consultar la sección de Preguntas Frecuentes para obtener respuestas inmediatas a los problemas más comunes.')
            res.end()
            break;
